...
import numpy
# input parameters
@Gooey(required_cols=2, program_name= 'retrieve N50, L50, N90 and L90', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser()
    ap.add_argument("-dir", "--directory", required=True, widget='DirChooser', type=str, help="output directory to read the multi-fasta files with scaffolds/chromosomes")
    ap.add_argument("-txt", "--txt", required=True,widget='FileSaver',help="output txt file with 5 columns filename, N50, L50, N90 and L90 values")
